<?php
	 ...
	 * 
	 * Для правильной работы необходимо определить константу DOCROOT содержащую корень сайта.
	 *
	...
	$vf["db"]["subd"]="mysql"; 				// Тип sql-сервера
	$vf["db"]["host"]="localhost"; 			// Адрес сервера
	$vf["db"]["login"]="root";				// Логин
	$vf["db"]["pass"]="";					// Пароль
	$vf["db"]["base"]="HomeMoney";			// Основная БД
